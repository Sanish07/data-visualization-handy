...
const ScatterChart = ({chartConfigData}) => {
  ...
  const handleExtraSets = (e) =>{
    if(e.target.id === "ex-ptFill"){
      setExtraSets({...extraSettings, pointFill : e.target.value})
  ...
  return (
    ...
    <div id="extra-settings">
      <label>Select Point Fill : </label>
      <input type="color" value={extraSettings.pointFill} onChange={handleExtraSets} id="ex-ptFill"/><br/>
          ...
          datasets : [
            {
              ...
              backgroundColor: extraSettings.pointFill,
